...
class RatesControllerTest < ActionController::TestCase
  ...
  test "should create rate" do
    assert_difference('Rate.count') do
      post :create, rate: { idea: @rate.idea, logo: @rate.logo, name: @rate.name, text: @rate.text, video: @rate.video, website: @rate.website }
    end
  ...
  test "should update rate" do
    put :update, id: @rate, rate: { idea: @rate.idea, logo: @rate.logo, name: @rate.name, text: @rate.text, video: @rate.video, website: @rate.website }
    assert_redirected_to rate_path(assigns(:rate))
  end
